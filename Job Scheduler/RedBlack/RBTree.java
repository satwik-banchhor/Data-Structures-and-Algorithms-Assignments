...
public class RBTree<T extends Comparable, E> implements RBTreeInterface<T, E>  {
    ...
    public void insert(T key, E value) {
    	RedBlackNode<T,E> insertnode=this.searchinsertpos(key);
    	if (insertnode==null) {
    		root=new RedBlackNode(key,value,Colour.black,null,null,null);
    	}
    		...
    		if (insertnode.colour==Colour.black) {//BlackParent case
    			if (insertnode.key.compareTo(key)>0) {
    				RedBlackNode<T,E> toinsertnode=new RedBlackNode<T,E>(key,value,Colour.red,insertnode,null,null);
    			...
    			RedBlackNode<T,E> toinsertnode;
    			if (insertnode.key.compareTo(key)>0) {
    				toinsertnode=new RedBlackNode<T,E>(key,value,Colour.red,insertnode,null,null);
    				insertnode.leftchild=toinsertnode;
    			}
    			else{
    				toinsertnode=new RedBlackNode<T,E>(key,value,Colour.red,insertnode,null,null);
    ...
    public void remove_double_red(RedBlackNode<T, E> node) {
		if (node.parent==null) {//node is a red root
			...
			if (uncle_colour.compareTo(Colour.red)==0) {//Case red uncle
				...
				RedBlackNode<T,E> t4;
				RedBlackNode<T,E> t5;
				RedBlackNode<T,E> n=node;
				RedBlackNode<T,E> p=parent;
				RedBlackNode<T,E> g=grandparent;
//				RedBlackNode<T,E> u=uncle;
				RedBlackNode<T,E> ggp=grandparent.parent;
...
//					t2=uncle.rightchild;
    ...
    public void rotateLL(RedBlackNode<T,E> n,RedBlackNode<T,E> p,RedBlackNode<T,E> g,RedBlackNode<T,E> t1,RedBlackNode<T,E> t2,RedBlackNode<T,E> t3, RedBlackNode<T, E> ggp) {
...
//    	}
    ...
    public void rotateLR(RedBlackNode<T,E> n,RedBlackNode<T,E> p,RedBlackNode<T,E> g,RedBlackNode<T,E> t1,RedBlackNode<T,E> t2,RedBlackNode<T,E> t3, RedBlackNode<T, E> ggp) {
    	if (ggp==null) {//grandparent was root
    		root=n;
    	}
    	else if (ggp.leftchild!=null){
...
//    	}
    ...
    public void rotateRL(RedBlackNode<T,E> n,RedBlackNode<T,E> p,RedBlackNode<T,E> g,RedBlackNode<T,E> t3,RedBlackNode<T,E> t4,RedBlackNode<T,E> t5, RedBlackNode<T, E> ggp) {
    	if (ggp==null) {//grandparent was root
    		root=n;
    	}
    	else if (ggp.leftchild!=null){
...
//    	}
    ...
    public void rotateRR(RedBlackNode<T,E> n,RedBlackNode<T,E> p,RedBlackNode<T,E> g,RedBlackNode<T,E> t3,RedBlackNode<T,E> t4,RedBlackNode<T,E> t5, RedBlackNode<T, E> ggp) {
    	if (ggp==null) {//grandparent was root
    		root=p;
    	}
    	else if (ggp.leftchild!=null){
...
//    	}
    ...
    public RedBlackNode<T, E> search(T key) {
    	//Returns null if not found, address/path followed to get search_node
   		RedBlackNode<T,E> currentnode = root;
   		boolean found = false;
    ...
    public RedBlackNode<T, E> searchinsertpos(T key) {
    	//Returns null if not found, address/path followed to get search_node
    	RedBlackNode<T,E> currentparent = null;
   		RedBlackNode<T,E> currentnode = root;
   		boolean found = false;
   		boolean is_empty = currentnode==null;
   		int x=0;
